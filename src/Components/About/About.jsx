  ...
  return (
    <div className="about">
      ...
      <div className="about-right">
        ...
        <p>Whether you aspire to become a teacher,administrator, counselor, or educational leader, our diverse range of programs offers the perfect pathway to achieve your goals and unlock your full potentials in shaping the future of education. </p>
      </div>
    </div>
  );
};
